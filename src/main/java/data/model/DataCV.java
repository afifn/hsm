...
public class DataCV {
    ...
    public DataCV(CardVerifiableCertificate cert, PublicKey publicKey, PrivateKey privateKey, CVCPrincipal cvcPrincipal, Date effDate, Date expDate, String signatureAlgoritm) {
        this.cert = cert;
